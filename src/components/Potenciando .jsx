            ...
            <div className="container">
                ...
                <div className="row">
                    <div className="col-lg-6">
                        <img className='w-100 h-100 max-w-558 mt-lg-0 mt-5' src={Imgejackport} alt="jackpot-img" />
                    </div>
                    {/* ellips */}
                ...
                {/* ============ */}
                <h2 className='heading color-white mx-auto text-center pt-150 pb-60 mt-lg-0 mt-5'>Juegos en vivo</h2>
                <div className="row justify-content-center text-center">
                    <div className='col-lg-4 col-md-6 position-relative card_hover mb-2'>
                        <div className='position-relative black_layer '>
                            <img className='w-100 max-w-364' src={ImageJuegos1} alt="ezugi1-img" />
                        </div>
                        <div className='position-absolute btn_none top-0 bottom-0 start-0 end-0 d-flex align-items-center justify-content-center'>
                            <div className='position-relative cursor-pointer d-inline-flex justify-content-center align-items-center btn-hover'>
                                <button className='btnn btn4style color-white '>Reproducir ahora</button>
                    ...
                    <div className='col-lg-4 col-md-6 position-relative card_hover mb-2'>
                        <div className='position-relative black_layer '>
                            <img className='w-100 max-w-364' src={ImageJuegos2} alt="roulette -img2" />
                        </div>
                        <div className='position-absolute btn_none top-0 bottom-0 start-0 end-0 d-flex align-items-center justify-content-center'>
                            <div className='position-relative cursor-pointer d-inline-flex justify-content-center align-items-center btn-hover'>
                                <button className='btnn btn4style color-white '>Reproducir ahora</button>
                    ...
                    <div className='col-lg-4 col-md-6 position-relative card_hover mb-2'>
                        <div className='position-relative black_layer '>
                            <img className='w-100 max-w-364' src={ImageJuegos3} alt="betting-img3" />
                        </div>
                        <div className='position-absolute btn_none top-0 bottom-0 start-0 end-0 d-flex align-items-center justify-content-center'>
                            <div className='position-relative cursor-pointer d-inline-flex justify-content-center align-items-center btn-hover'>
                                <button className='btnn btn4style color-white '>Reproducir ahora</button>
