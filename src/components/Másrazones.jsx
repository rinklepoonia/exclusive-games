            ...
            <div className='container'>
                ...
                <div className="row ">
                    <div className="col-lg-6 mas-img-property">
                        <img className='w-100 h-100 object-fit-cover position-relative' src={ImageMas} alt="img-777" />
                    </div>
                    <div className="col-lg-6">
                        <div className='d-flex flex-column item-center'>
                            <h2 className='heading color-white mb-60'>Más razones para elegirnos</h2>
                            <div className=' d-flex flex-column gap-24'>
                                <div className='mas-box py-24 cursor-pointer'>
                                    <div className='d-flex align-items-center gap-37 '>
                                        <img className='ms-56' src={ImageMas1} alt="bulb-img777" />
